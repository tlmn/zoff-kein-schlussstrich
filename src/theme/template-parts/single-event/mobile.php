<div class="block md:hidden">
        ...
        <div class="col-span-1">
            <a href="/kalender" class="hover:fill--blue">
                <?php echo file_get_contents(
                    get_template_directory() . '/assets/icons/back--mobile.svg'
                ); ?>
            </a>
        </div>
    ...
    <div class="grid-6  bg-white text-black">
        <div class="col-span-full">
            ...
            <div class="mx-2 my-3">
                ...
                if ($currentEvent['alarm'] !== '') { ?>
                    <span class="inline-block bg-yellow text-black uppercase font-medium rounded-3xl px-3 py-2 mb-6">
                        <?php echo $currentEvent['alarm']; ?>
                    </span>
                <?php }
                if (time_short($currentEvent['time'], ':') !== '00:00') { ?>
                    <span class="text-3xl font-medium leading-snug block"><?php print time_short(
                        $currentEvent['time'],
                        ':'
                    ); ?>h</span>
                <?php }
                ...
                <div class="flex gap-2">
                    <a href="<?php echo get_fields(
                        ...
                        <?php echo $currentEvent['venue'][0]->post_title; ?>
                    </a>
                    <?php if (
        ...
        <?php if (
            isset(get_fields()['meta']['feature_image']['image']['ID'])
        ) { ?>
            <div class="col-span-full">
                <?php $feature_image_srcset = wp_get_attachment_image_srcset(
                    get_fields()['meta']['feature_image']['image']['ID']
                ); ?>
    ...
    if (
        array_key_exists('credits', $currentEvent) &&
        $currentEvent['general']['credits'] !== ''
    ) { ?>
        <div class="grid-6 border-b-2 ">
    ...
    <?php }
    if (
        array_key_exists('short_description', $currentEvent) &&
        $currentEvent['general']['short_description'] !== ''
    ) { ?>
        <div class="grid-6 border-b-2 ">
    ...
    <?php if ($currentEvent['general']['duration'] !== '') { ?>
        <div class="grid-6 border-b-2 ">
            <div class="col-span-full py-6 px-3">
            ...
            <div class="grid-6 border-b-2 ">
                <div class="col-span-full py-6 px-3 text-lg font-medium">
                    ...
                    <span class="block">
                        ...
                        <?php echo $currentVenue['address']['street'] .
                            ' ' .
                            $currentVenue['address']['houseNumber']; ?><br />
                        <?php echo $currentVenue['address']['postleitzahl'] .
                            ' ' .
                            $currentVenue['address']['city']; ?><br />
                    </span>
                </div>
            </div>
    ...
    if (
        array_key_exists('url', $currentVenue) &&
        $currentVenue['url'] !== ''
    ) { ?>
            <div class="grid-6 border-b-2 ">
        ...
        <div class="grid-6 border-b-2 ">
            <div class="col-span-full py-6 px-3">
                <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo get_permalink() .
                    ...
                    $date .
                    '&time=' .
                    $time; ?>" target="_blank" class="font-medium underline hover:no-underline flex items-center text-lg">
                    <span class="mr-2">
                        <?php echo file_get_contents(
            ...
            <div class="grid-6">
                <div class="col-span-full py-6 px-3 text-lg font-medium">
                    ...
                    <?php while (have_rows('occurrences')):
                        ...
                        the_row();
                        $timestamp = strtotime(
                            str_replace('/', '-', get_sub_field('timestamp'))
                        );
                        ?>
