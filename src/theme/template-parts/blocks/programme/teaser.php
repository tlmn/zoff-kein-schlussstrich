    ...
    <div class="container grid-6 md:grid-16 md:border-l-2 md:border-r-2">
        ...
        <div class="col-span-full md:col-span-4 flex flex-col md:border-r-2">
            ...
            <div class="self-end w-full flex flex-col">
                ...
                ?>
                    <a href="<?php echo get_permalink($programmeLink['link']->ID); ?>" class="no-underline w-full px-2 py-1 text-2xl text-black leading-wider font-normal shadow--bottom z-20 bg-<?php echo $programmeLink['bgColor'] ?>" style="z-index: <?php echo 100 - ($i * 10); ?>">
        ...
        <div class="col-span-full md:col-span-9 py-7 md:p-7 px-2 md:px-0 ">
